...
rotationMatrix.setRotate(-90, 0,1,0);
rotationMatrix.rotate(-90,1,0,0);

// rotationMatrix.setRotate(180, 1,0,0);
// rotationMatrix.rotate(180,0,1,0);
...
OBJDoc.prototype.parseVertex = function(sp, scale) {
    ...
    vect = new Vector4([x,y,z,1.0]);
    vect = rotationMatrix.multiplyVector4(vect);

    return (new Vertex(vect.elements[0], vect.elements[1], vect.elements[2]));
...
OBJDoc.prototype.parseNormal = function(sp) {
    ...
    return (new Normal(vect.elements[0], vect.elements[1], vect.elements[2]));
